...
class Command(BaseCommand):
    def handle(self, *args, **options):
        self.stdout.write("Start making Electric Charge Station data\n")

        file_path = os.path.join(settings.BASE_DIR, "data", "electric_charge.json")
        ...
        self.stdout.write("\n")
        self.stdout.write("Make Electric Charge Station Data is Done. :D\n")
        self.stdout.write(
            "------------------------------------------------------------\n"
        )
